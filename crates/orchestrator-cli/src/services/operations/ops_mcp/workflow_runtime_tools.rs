...
impl AoMcpServer {
    ...
    #[tool(
        ...
        description = "Approve a gated workflow phase. Purpose: Unblock gate phases that require manual approval before proceeding. Prerequisites: Workflow must have a pending gate phase. Example: {\"workflow_id\": \"wf-abc123\", \"phase\": \"po-review\"} or {\"workflow_id\": \"wf-abc123\", \"phase\": \"po-review\", \"note\": \"Approved\"}. Sequencing: Use ao.workflow.get first to see pending gates, then ao.workflow.phase.approve to unblock.",
    ...
    async fn ao_workflow_phase_approve(
        ...
        push_opt(&mut args, "--note", input.note);
    ...
    #[tool(
        ...
        description = "Reject a gated workflow phase. Purpose: Block gate phases that require manual approval, sending the workflow to a failed or rework state. Prerequisites: Workflow must have a pending gate phase. Example: {\"workflow_id\": \"wf-abc123\", \"phase\": \"po-review\", \"note\": \"Output quality insufficient\"}. Sequencing: Use ao.workflow.get first to see pending gates, then ao.workflow.phase.reject to block.",
