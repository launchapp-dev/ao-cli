...
pub(crate) const AI_RECOVERY_TIMEOUT_SECS: u64 = 120;
pub(crate) const AI_RECOVERY_MARKER: &str = "ai-failure-recovery";
pub(crate) const MAX_DECOMPOSE_SUBTASKS: usize = 3;

#[derive(Debug, Clone, Deserialize)]
#[allow(dead_code)]
pub(crate) struct AiRecoveryResponse {
    pub(crate) action: String,
    #[serde(default)]
    pub(crate) reason: String,
    #[serde(default)]
    pub(crate) subtasks: Vec<AiRecoverySubtask>,
}

#[derive(Debug, Clone, Deserialize)]
pub(crate) struct AiRecoverySubtask {
    pub(crate) title: String,
    #[serde(default)]
    pub(crate) description: String,
}

pub(crate) enum AiRecoveryAction {
    Retry,
...
pub(crate) fn task_requires_research(task: &orchestrator_core::OrchestratorTask) -> bool {
...
pub(crate) fn workflow_has_completed_research(
...
pub(crate) fn workflow_has_active_research(
    workflow: &orchestrator_core::OrchestratorWorkflow,
) -> bool {
    workflow.phases.iter().any(|phase| {
        phase.phase_id == "research"
...
pub(crate) fn phase_execution_events_from_signals(
    project_root: &str,
    workflow: &orchestrator_core::OrchestratorWorkflow,
...
pub(crate) async fn attempt_ai_failure_recovery(
    project_root: &str,
...
pub(crate) fn parse_ai_recovery_response(text: &str) -> Option<AiRecoveryResponse> {
