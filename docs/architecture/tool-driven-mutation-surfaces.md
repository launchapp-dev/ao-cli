...
- Agents and phases mutate domain state by invoking `animus` commands or MCP tools.
...
- generate tasks from a requirement by calling typed `animus` or MCP mutation tools
