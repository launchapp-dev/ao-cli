...
This guide explains how AI agents (and MCP clients) interact with the Animus orchestrator through its MCP tool surface. Every tool maps 1:1 to an `animus` CLI command and accepts JSON input.
