...
│
├── planning                 Plan and refine vision and requirements
│   ├── vision               Manage project vision planning
│   │   ├── draft            Draft project vision
│   │   └── refine           Refine project vision
│   └── requirements         Manage requirements planning
│       ├── draft            Draft requirements
│       ├── refine           Refine requirements
│       └── execute          Execute a requirement into implementation tasks
│
...
| Total subcommands (all levels) | 197 |
